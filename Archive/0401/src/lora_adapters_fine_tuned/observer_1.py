...
def monitor_and_upload_all():
    ...
    while True:
        ...
        if len(ready_folders) >= BATCH_SIZE:
            ...
            # zip_base_name = f"backup_6_3_{count}"
            zip_base_name = f"backup_6_3_12"
            ...
            try:
                ...
                google_upload.upload_to_drive(file_path = zip_filename, folder_id = GOOGLE_DRIVE_FOLDER_ID)
